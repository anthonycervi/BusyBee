...
const EditTaskCard = ({onPreview, show, border, InputTitle1,InputPlaceholder1,InputTitle2,InputPlaceholder2,InputTitle3,InputPlaceholder3,onFormComplete}) => {
